# Sekarang akan dicoba melakukan proses downsampling
# pada dataset 'https://dqlab-dataset.s3-ap-southeast-1.amazonaws.com/LO4/global_air_quality_4000rows.csv'
# yang telah di load sebelumnya.
