# Selanjutnya untuk memvisualisasikan dengan menggunakan library matplotlib dataframe
# yang telah diolah (seperti yang telah dipelajari dari bab pertama hingga subbab sebelumnya di bab ini).
